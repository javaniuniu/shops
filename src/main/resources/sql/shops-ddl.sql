...
) ENGINE=MyISAM AUTO_INCREMENT=1002 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of t_news
-- ----------------------------
BEGIN;
INSERT INTO `t_news` VALUES (1000, '2020-03-02 00:00:00', '2020-03-02 19:07:18', 'javanews1', 'javan牛牛', 1);
INSERT INTO `t_news` VALUES (1001, '2020-03-02 16:55:41', '2020-03-02 19:07:29', 'niuniu', 'javaniuniu', 1);
COMMIT;
...
) ENGINE=MyISAM AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of t_order
-- ----------------------------
BEGIN;
INSERT INTO `t_order` VALUES (2, '2020-03-02 05:51:26', '2020-03-02 17:31:10', '杭州', '2020-03-02 17:31:10', 'java牛牛', 15000, '20200302135159', '2020-03-02 17:31:10', '18620668927', '2020-03-02 17:31:10', 4, 15000, '335000', 1);
INSERT INTO `t_order` VALUES (3, '2020-03-02 05:53:57', '2020-03-02 15:03:16', '杭州', '2020-03-02 15:03:16', 'java牛牛', 5000, '20200302135353', '2020-03-02 15:03:16', '18620668927', '2020-03-02 15:03:16', 3, 5000, '335000', 1);
INSERT INTO `t_order` VALUES (4, '2020-03-02 05:56:59', '2020-03-02 17:32:42', '杭州', '2020-03-02 17:32:42', 'java牛牛', 5000, '20200302135649', '2020-03-02 17:32:42', '18620668927', '2020-03-02 17:32:42', 3, 5000, '335000', 1);
INSERT INTO `t_order` VALUES (5, '2020-03-02 13:57:55', '2020-03-02 17:32:44', '杭州', '2020-03-02 17:32:44', 'java牛牛', 5000, '20200302135770', '2020-03-02 17:32:44', '18620668927', '2020-03-02 17:32:44', 1, 5000, '335000', 1);
INSERT INTO `t_order` VALUES (6, '2020-03-02 06:04:26', '2020-03-02 06:04:26', '杭州', '2020-03-02 14:04:27', 'java牛牛', 10000, '20200302140482', '2020-03-02 14:04:27', '18620668927', '2020-03-02 14:04:27', 0, 10000, '335000', 1);
INSERT INTO `t_order` VALUES (22, '2020-03-02 14:48:36', '2020-03-02 14:48:36', '杭州', '2020-03-02 14:48:36', 'java牛牛', 5000, '20200302144852', '2020-03-02 14:48:36', '18620668927', '2020-03-02 14:48:36', 0, 5000, '335000', 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_orderitem` VALUES (12, '2020-03-02 14:48:37', '2020-03-02 14:48:37', 1, 22, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_picture` VALUES (1, '2019-09-25 15:49:09', '2020-03-02 04:24:10', '商品上传', '商品上传', '/img/1569397749301.jpg', 1);
INSERT INTO `t_picture` VALUES (2, '2020-03-02 15:40:00', '2020-03-02 15:40:00', '商品上传', '商品上传', '/img/1583134799990.jpg', 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_product` VALUES (1, '2019-09-25 15:49:09', '2020-03-02 05:18:59', '123789435789235879', '2080TI', '2080TI', 5000, 12, '七彩虹RTX2080TI', 1, 1);
INSERT INTO `t_product` VALUES (2, '2020-03-02 15:40:00', '2020-03-02 15:40:00', '14278974598234', '2020', '建议买', 18000, 100, 'macpro', 1, 2);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_user` VALUES (1, '2019-09-25 15:44:06', '2020-03-02 02:36:30', NULL, NULL, 0, '123456', NULL, 0, NULL, NULL, NULL, 'javaniuniu', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_useraddress` VALUES (11, '2020-03-02 17:33:21', '2020-03-02 19:30:16', '广东', 'java牛牛', '18620668927', '310013', 1);
INSERT INTO `t_useraddress` VALUES (6, '2020-03-02 15:08:35', '2020-03-02 15:08:35', '广东', 'java牛牛2', '18620668927', '020', 1);
COMMIT;
